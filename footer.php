...
<footer class="mp-footer" id="contact">
    <div class="mp-container">
        ...
        <section class="mp-footer-main">
            <!-- Fixed design: newsletter stays at the LEFT. -->
            ...
            <div class="mp-footer-column">
                <?php if ( is_active_sidebar( 'footer-column-1' ) ) : dynamic_sidebar( 'footer-column-1' ); else : ?>
                    <h3>دسته‌بندی‌ها</h3><a href="<?php echo esc_url( home_url( '/#courses' ) ); ?>">مکالمه</a><a href="<?php echo esc_url( home_url( '/#courses' ) ); ?>">گرامر</a><a href="<?php echo esc_url( home_url( '/#courses' ) ); ?>">لغات</a><a href="<?php echo esc_url( home_url( '/#courses' ) ); ?>">شنیداری</a><a href="<?php echo esc_url( home_url( '/#courses' ) ); ?>">آمادگی آزمون</a>
                <?php endif; ?>
            </div>

            <div class="mp-footer-column">
                <?php if ( is_active_sidebar( 'footer-column-2' ) ) : dynamic_sidebar( 'footer-column-2' ); elseif ( has_nav_menu( 'footer' ) ) : ?>
                    <h3>دسترسی سریع</h3><?php wp_nav_menu( array( 'theme_location' => 'footer', 'container' => false, 'menu_class' => 'mp-footer-menu', 'fallback_cb' => false ) ); ?>
                <?php else : ?>
                    <h3>دسترسی سریع</h3><a href="<?php echo esc_url( home_url( '/#courses' ) ); ?>">دوره‌ها</a><a href="<?php echo esc_url( home_url( '/#videos' ) ); ?>">ویدئوهای آموزشی</a><a href="#">وبلاگ</a><a href="<?php echo esc_url( home_url( '/#about' ) ); ?>">درباره من</a><a href="#contact">تماس با من</a>
                <?php endif; ?>
            </div>

            <!-- Editable content: this is always the RIGHTMOST column. -->
            <div class="mp-footer-column mp-footer-about">
                <?php if ( is_active_sidebar( 'footer-column-3' ) ) : dynamic_sidebar( 'footer-column-3' ); else : ?>
                    <h3>درباره من</h3><p>من با بیش از ۷ سال تجربه در آموزش زبان انگلیسی، در کنار شما هستم تا مسیر یادگیری را ساده و کاربردی دنبال کنید.</p>
                <?php endif; ?>
                <?php if ( is_active_sidebar( 'footer-social' ) ) : ?>
                    <div class="mp-footer-social-widget-area"><?php dynamic_sidebar( 'footer-social' ); ?></div>
                <?php endif; ?>
            </div>
        </section>
...
<!-- NOT part of footer: floating support on every page. -->
