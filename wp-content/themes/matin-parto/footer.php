<?php
/** Matin Parto footer. Newsletter is fixed; only selected footer sections are widget-editable. */
...
<footer class="mp-footer" id="contact">
    <div class="mp-container">
        <section class="mp-footer-main">
            <!-- ثابت: کاربر این بخش را از ابزارک‌ها تغییر نمی‌دهد. -->
            ...
            <!-- درباره من + ابزارک‌های شبکه اجتماعی -->
...
<!-- خارج از فوتر و ثابت در تمام صفحات -->
