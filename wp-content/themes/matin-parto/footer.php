...
.mp-footer-social .mp-social-widget{width:100%!important;text-align:center!important}
.mp-footer-social .mp-social-widget__content{display:flex!important;flex-direction:column!important;align-items:center!important;gap:4px!important}
.mp-footer-social .mp-social-widget__title{font-size:11px!important;line-height:1.7!important}
.mp-footer-social .mp-social-widget__text{font-size:9px!important;line-height:1.9!important;color:#746b6d!important}
.mp-footer-social .mp-social-icons{display:flex!important;align-items:center!important;justify-content:center!important;gap:10px!important;margin-top:8px!important}
.mp-footer-social .mp-social-icon{width:30px!important;height:30px!important;border:1px solid #d9c8ca!important;border-radius:50%!important;display:grid!important;place-items:center!important;color:#7b2636!important;text-decoration:none!important;transition:transform .2s ease,background .2s ease,color .2s ease!important}
.mp-footer-social .mp-social-icon:hover,.mp-footer-social .mp-social-icon:focus-visible{color:<?php echo esc_attr( $footer_hover_color ); ?>!important;background:#fff!important;transform:translateY(-2px)!important}
.mp-footer-social .mp-social-icon svg{width:15px!important;height:15px!important;fill:none!important;stroke:currentColor!important;stroke-width:1.7!important;stroke-linecap:round!important;stroke-linejoin:round!important}
...
<div class="mp-footer-social" aria-label="شبکه‌های اجتماعی"><?php dynamic_sidebar( 'matin-parto-social' ); ?></div>
<?php endif; ?>
