<?php
/**
 * Footer — Matin Parto reference UI.
 */
        ...
        <section class="mp-footer-main">
            ...
            <div class="mp-footer-column">
                ...
                if ( has_nav_menu( 'footer' ) ) {
                    wp_nav_menu( array( 'theme_location' => 'footer', 'container' => false, 'menu_class' => 'mp-footer-menu', 'fallback_cb' => false ) );
                } else {
                    echo '<a href="' . esc_url( home_url( '/#courses' ) ) . '">دوره‌ها</a><a href="' . esc_url( home_url( '/#videos' ) ) . '">ویدئوهای آموزشی</a><a href="#">وبلاگ</a><a href="' . esc_url( home_url( '/#about' ) ) . '">درباره من</a><a href="#contact">تماس با ما</a>';
                }
                ?>
            </div>
            <div class="mp-footer-column mp-footer-about">
                ...
                <div class="mp-footer-socials"><a href="#" aria-label="اینستاگرام">◎</a><a href="#" aria-label="تلگرام">➤</a><a href="#" aria-label="یوتیوب">▶</a></div>
            </div>
        </section>
        <div class="mp-footer-bottom"><span>Matin Parto © 2026</span><div><a href="#">حریم خصوصی</a><a href="#">قوانین و مقررات</a></div><span>طراحی و توسعه با وردپرس</span></div>
    </div>
</footer>
