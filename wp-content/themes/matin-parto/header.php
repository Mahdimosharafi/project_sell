...
<?php wp_head(); ?>
<link rel="stylesheet" href="<?php echo esc_url( get_template_directory_uri() . '/assets/css/final-ui-fixes.css?v=20260913-4' ); ?>">
<style>
/* Header actions are explicitly ordered left-to-right: account, cart, search. */
.mp-header__actions{left:0!important;right:auto!important;direction:ltr!important;display:flex!important;flex-direction:row!important;align-items:center!important;}
    ...
    <header class="mp-header">
        <div class="mp-container mp-header__inner">
            ...
            <div class="mp-header__actions">
                <!-- DOM order is intentionally account -> cart -> search so account is physically far-left. -->
