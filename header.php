...
<nav class="mp-nav" aria-label="منوی اصلی"><ul class="mp-nav__list"><li class="is-current"><a href="<?php echo esc_url( home_url( '/' ) ); ?>">صفحه اصلی</a></li><li><a href="#courses">دوره ها</a></li><li><a href="#about">درباره من</a></li><li><a href="#videos">ویدیو های آموزشی</a></li><li><a href="#blog">وبلاگ</a></li><li><a href="<?php echo esc_url( home_url( '/contact/' ) ); ?>">تماس با ما</a></li></ul></nav>
