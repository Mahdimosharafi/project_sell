...
<nav class="mp-nav" aria-label="منوی اصلی"><?php if ( has_nav_menu( 'primary' ) ) { wp_nav_menu( array( 'theme_location'=>'primary','container'=>false,'menu_class'=>'mp-nav__list','fallback_cb'=>'matin_parto_fallback_menu' ) ); } else { matin_parto_fallback_menu(); } ?></nav>
<a class="mp-brand" href="<?php echo esc_url( home_url( '/' ) ); ?>" aria-label="متین پارتو"><?php if ( has_custom_logo() ) { the_custom_logo(); } else { ?><span class="mp-brand__latin">MATIN<br>PARTO</span><span class="mp-brand__line">ENGLISH ACADEMY</span><?php } ?></a>
</div></header>
